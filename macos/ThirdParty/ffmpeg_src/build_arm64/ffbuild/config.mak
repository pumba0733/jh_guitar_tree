...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/jaehyounglee/Desktop/guitartree/guitartree/macos/thirdparty/ffmpeg_src/build_arm64/../../ffmpeg/arm64 --arch=arm64 --target-os=darwin --enable-shared --disable-static --enable-pic --disable-programs --disable-doc --disable-debug
...
CFLAGS-ffplay=-I/opt/homebrew/include -I/opt/homebrew/include/SDL2 -D_THREAD_SAFE
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-framework Foundation -framework AudioToolbox -framework CoreAudio -lm -framework AVFoundation -framework CoreVideo -framework CoreMedia -framework CoreGraphics -L/opt/homebrew/Cellar/libxcb/1.17.0/lib -lxcb -L/opt/homebrew/Cellar/libxcb/1.17.0/lib -lxcb-shm -L/opt/homebrew/Cellar/libxcb/1.17.0/lib -lxcb-shape -L/opt/homebrew/Cellar/libxcb/1.17.0/lib -lxcb-xfixes -framework AudioToolbox -pthread -L/opt/homebrew/lib -lSDL2
...
EXTRALIBS-avutil=-pthread -lm -framework VideoToolbox -L/opt/homebrew/Cellar/libx11/1.8.12/lib -lX11 -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
