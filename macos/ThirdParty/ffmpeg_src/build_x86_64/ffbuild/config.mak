...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/Users/jaehyounglee/Desktop/guitartree/guitartree/macos/thirdparty/ffmpeg_src/build_x86_64/../../ffmpeg/x86_64 --arch=x86_64 --target-os=darwin --cc='clang -arch x86_64' --cxx='clang++ -arch x86_64' --extra-cflags='-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk' --extra-ldflags='-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk' --enable-shared --disable-static --enable-pic --disable-programs --disable-doc --disable-debug
prefix=/Users/jaehyounglee/Desktop/guitartree/guitartree/macos/thirdparty/ffmpeg_src/build_x86_64/../../ffmpeg/x86_64
...
SRC_PATH=/Users/jaehyounglee/Desktop/guitartree/guitartree/macos/thirdparty/ffmpeg_src
SRC_LINK=src
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Apple clang version 17.0.0 (clang-1700.0.13.5)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
CC=clang -arch x86_64
CXX=clang++ -arch x86_64
AS=clang -arch x86_64
OBJCC=clang -arch x86_64
LD=clang -arch x86_64
DEPCC=clang -arch x86_64
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=clang -arch x86_64
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CFLAGS=  -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk -fPIC -Qunused-arguments
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m64 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include src/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
HOSTCC=clang -arch x86_64
HOSTLD=clang -arch x86_64
HOSTCFLAGS=  -std=c99 -Wall -O3
HOSTCPPFLAGS= -D_ISOC99_SOURCE
HOSTEXESUF=
HOSTLDFLAGS= 
HOSTEXTRALIBS=-lm
DEPHOSTCC=clang -arch x86_64
...
EXTRALIBS-avfilter=-framework OpenGL -framework OpenGL -pthread -lm -framework Metal -framework VideoToolbox -framework CoreImage -framework AppKit -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz -Wl,-framework,CoreFoundation -Wl,-framework,Security
EXTRALIBS-avcodec=-liconv -lm -framework AudioToolbox -pthread -lz -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
